...
try:
    ...
    channel.queue_declare(queue='quoraI_html_parse')
    ...
    def callback(ch, method, properties, body):
        ...
        for item in jobs:
            ...
            channel.basic_publish(exchange='', routing_key='quoraI_fetch_job_details', body=json.dumps(job))
        else:
            print("no Jobs data !!")

    channel.basic_consume(
        queue='quoraI_html_parse', on_message_callback=callback, auto_ack=True)
