...
def fetch_data():
    try: 
        urls = json.loads(os.getenv("NO_CODE_FOUNDERS_SEARCH_URL"))
        print(len(urls))
        ...
        for url in urls:
            ...
            channel.basic_publish(exchange='', routing_key='no_code_founders_html_parse', body=page)
        ...
        error = {
            "status": "No Code Founders........... Error occured while fetching html",
            "errorMsg": e
        }
        print("Error: ",error)
