...
try:
    ...
    def callback(ch, method, properties, body):
        ...
        try:
            ...
            job['company'] = soup.find("h2", class_="bubble-element Text clickable-element").getText().strip() if soup.find("h2", class_="bubble-element Text clickable-element") else ''
            job['location'] = ""
            description = soup.find_all("div", class_="bubble-element Text") if soup.find("div", class_="bubble-element Text") else None
            job['description'] = ''
            i = 0
