...
try:
    ...
    # channel.basic_consume(callback, 'zip_recruiter_fetch_job_details',  no_ack=False)
    channel.basic_consume(
       queue='zip_recruiter_fetch_job_details', on_message_callback=callback, auto_ack=False)
