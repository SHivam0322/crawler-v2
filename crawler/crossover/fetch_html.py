...
def fetch_data():
    try: 
        urls = json.loads(os.getenv("CROSSOVER_SEARCH_URL"))
        print(len(urls))
        ...
        for url in urls:
            ...
            channel.basic_publish(exchange='', routing_key='crossover_html_parse', body=page)
            print("Crossover data sent to parse queue...")
        ...
        error = {
            "status": "Crossover........... Error occured while fetching html",
            "errorMsg": e
        }
        print("Error: ",error)
